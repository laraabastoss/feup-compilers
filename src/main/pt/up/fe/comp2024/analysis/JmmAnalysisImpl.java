...
public class JmmAnalysisImpl implements JmmAnalysis {
    ...
    public JmmAnalysisImpl() {
        ...
        this.analysisPasses = List.of(new UndeclaredVariable(), new InvalidOperations(), new InvalidAssignments(), new InvalidConditions(), new InvalidMethodCalls(), new InvalidDeclarations(), new InvalidUseOfThis());
